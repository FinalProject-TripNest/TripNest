   ...
   <div id="wrap">
      <div id="reservation">
         <div class="center">
            ...
            <div class="detailbox">
               <form action="insert" class="bookingfrm">
                     ...
                     <li class="booking-room-options"><div class="tit">동의사항</div>
                        <div class="cont">
                           <div class="option_select agree_all">
                              <div class="tit">
                                 <label class="check_skin" for="room-agree-all" id="labelSize">
                                    <div style="display: flex;">
                                       <input type="checkbox" id="room-agree-all"
                                          name="room-agree-all" data-gtm-form-interact-field-id="3">
                           ...
                           <div class="option_select agree_each">
                              <div class="tit">
                                 <label class="check_skin" for="room-agree-2687"><input
                                    type="checkbox" id="room-agree-2687" name="room-agree-2687"><span
                           ...
                           <div class="option_select agree_each">
                              <div class="tit">
                                 <label class="check_skin" for="room-agree-2688"><input
                                    type="checkbox" id="room-agree-2688" name="room-agree-2688"><span
                           ...
                           <div class="option_select agree_each">
                              <div class="tit">
                                 <label class="check_skin" for="room-agree-2689"><input
                                    type="checkbox" id="room-agree-2689" name="room-agree-2689"><span
